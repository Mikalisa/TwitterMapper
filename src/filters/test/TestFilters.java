...
public class TestFilters {
    ...
    public void testAnd(){
        ...
        assertFalse(f.matches(makeStatus("fred and Flintstone")));
        assertFalse(f.matches(makeStatus("Fred and Flintstone")));
        assertTrue(f.matches(makeStatus("Red and Skelton")));
        assertTrue(f.matches(makeStatus("red and Skelton")));
    ...
    public void testOr(){
        ...
        assertFalse(f.matches(makeStatus("fred or Flintstone")));
        assertFalse(f.matches(makeStatus("Fred or Flintstone")));
        assertTrue(f.matches(makeStatus("Red or Skelton")));
        assertTrue(f.matches(makeStatus("red or Skelton")));
